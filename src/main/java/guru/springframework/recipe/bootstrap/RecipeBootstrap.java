...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        guacRecipe.getIngredients().add(new Ingredient("Kosher salt", new BigDecimal(".5"), teapsoonUom));
        ...
        tacosRecipe.getIngredients().add(new Ingredient("Dried Oregano", new BigDecimal(1), teapsoonUom));
        tacosRecipe.getIngredients().add(new Ingredient("Dried Cumin", new BigDecimal(1), teapsoonUom));
        tacosRecipe.getIngredients().add(new Ingredient("Sugar", new BigDecimal(1), teapsoonUom));
        tacosRecipe.getIngredients().add(new Ingredient("Salt", new BigDecimal(".5"), teapsoonUom));
