...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        UnitOfMeasure tableSpoonUom = unitOfMeasureService.findByDescription("Tablespoon");
        UnitOfMeasure teapsoonUom = unitOfMeasureService.findByDescription("Teaspoon");
        UnitOfMeasure dashUom = unitOfMeasureService.findByDescription("Dash");
        UnitOfMeasure pintUom = unitOfMeasureService.findByDescription("Pint");
        UnitOfMeasure cupsUom = unitOfMeasureService.findByDescription("Cup");

        Category americanCategory = categoryService.findByDescription("American");
        Category mexicanCategory = categoryService.findByDescription("Mexican");
        ...
        guacRecipe.getIngredients().add(new Ingredient("Kosher salt", new BigDecimal(".5"), teapsoonUom, guacRecipe));
        ...
        tacosRecipe.getIngredients().add(new Ingredient("Dried Oregano", new BigDecimal(1), teapsoonUom, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("Dried Cumin", new BigDecimal(1), teapsoonUom, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("Sugar", new BigDecimal(1), teapsoonUom, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("Salt", new BigDecimal(".5"), teapsoonUom, tacosRecipe));
