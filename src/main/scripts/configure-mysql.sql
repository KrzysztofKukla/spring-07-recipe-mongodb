...
#Database grants, so only those users: sfg_dev_user and sfg_prod_user are able to do DML ( CRUD operations )
...
#to be able to run on docker with different ip address
